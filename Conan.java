...
public class Conan {
  ...
  public static void main(String[] args) {
    Human jebolanDon = new Human("Don", 40, "Nevada", 10000000);
    Human jebolanUnderboss = new Human("Underboss",25, "Nevada", 1500000 );
    Human jebolanCapo = new Human("Capo",28, "manhattan", 900000);
    Human jebolanNusaPutra = new Human("Fidaos", 20, "Indonesia", 700);
